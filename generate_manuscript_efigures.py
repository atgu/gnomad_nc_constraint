...
if fig_x.lower() == "all":
    ...
    plt_prop_z4_cd("eFigure_2a.pdf")
    print ("Plotting eFig.2b ...")
    plt_hist_freq_z_exonic("eFigure_2b.pdf")
    ...
    plt_z_ptcl_annot_cd("eFigure_3a.pdf")
    print ("Plotting eFig.3b ...")
    plt_z_ptcl_annot_nc("eFigure_3b.pdf")
    ...
    plt_comparison_roc("gwas_catalog","gnomad_maf5",0,"eFigure_5a-1.pdf")
    plt_comparison_roc("gwas_fine-mapping","gnomad_maf5",0,"eFigure_5a-2.pdf")
    plt_comparison_roc("gwas_fine-mapping_hc","gnomad_maf5",0,"eFigure_5a-3.pdf")
    plt_comparison_roc("clinvar_pathogenic","gnomad_mac1",0,"eFigure_5a-4.pdf")
    ...
    plt_comparison_auc_af("clinvar_pathogenic","eFigure_5b-4.pdf")

    print ("Plotting eFig.6 ...")
    plt_comparison_roc_z("gwas_catalog","gnomad_maf5",0,"eFigure_6-1.pdf")
    plt_comparison_roc_z("gwas_fine-mapping","gnomad_maf5",0,"eFigure_6-2.pdf")
    plt_comparison_roc_z("gwas_fine-mapping_hc","gnomad_maf5",0,"eFigure_6-3.pdf")
    plt_comparison_roc_z("clinvar_pathogenic","gnomad_mac1",0,"eFigure_6-4.pdf")

    print ("Plotting eFig.7 ...")
    plt_score_corr(["Constraint Z","Orion","CDTS","gwRVIS","DR","phyloP","phastCons","GERP"],"eFigure_7.pdf")
